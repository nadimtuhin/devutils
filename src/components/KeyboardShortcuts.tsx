        ...
        <div className="p-6">
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <span className="dark:text-white">Open Spotlight Search</span>
            ...
            <div className="flex justify-between items-center">
              <span className="dark:text-white">Show Keyboard Shortcuts</span>
              <kbd className="px-2 py-1 bg-gray-100 rounded">⌘ ?</kbd>
            </div>
            <div className="flex justify-between items-center">
              <span className="dark:text-white">Navigate Tools</span>
              <kbd className="px-2 py-1 bg-gray-100 rounded">↑/↓</kbd>
            </div>
            <div className="flex justify-between items-center">
              <span className="dark:text-white">Select Tool</span>
